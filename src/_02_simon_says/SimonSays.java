...
public class SimonSays extends KeyAdapter {
	...
	public void run() {
		...
		// key when
		 JOptionPane.showMessageDialog(null, "Press the W key for up, A for left, D for right, and S for down, but only when simon says. if simon doesn't say, press a different key");
...
if(tries >11) {
	...
	speak("you scored "+ scoreString +" points!");
	System.exit(0);
}
